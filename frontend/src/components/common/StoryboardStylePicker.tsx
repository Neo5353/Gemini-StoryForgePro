...
const STORYBOARD_STYLES: StoryboardStyle[] = [
  {
    id: 'cinema',
    name: 'Film / Cinema',
    desc: 'Detailed pencil, cinematic framing, dramatic lighting',
    image: '/styles/cinema.png',
  },
  {
    id: 'animation',
    name: 'Animation',
    desc: 'Color keys, motion arcs, expressive characters',
    image: '/styles/animation.png',
  },
  {
    id: 'sketch',
    name: 'Rough Thumbnail',
    desc: 'Quick gestural sketches, loose composition',
    image: '/styles/sketch.png',
  },
  {
    id: 'technical',
    name: 'Technical',
    desc: 'Camera angles, lens notes, precise blocking',
    image: '/styles/technical.png',
  },
];
