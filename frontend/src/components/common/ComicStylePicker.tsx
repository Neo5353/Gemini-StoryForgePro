...
const COMIC_STYLES: ComicStyle[] = [
  {
    id: 'american',
    name: 'American Superhero',
    desc: 'Bold colors, dynamic action, strong outlines',
    image: '/styles/american.png',
  },
  {
    id: 'european',
    name: 'Franco-Belgian',
    desc: 'Clean ligne claire, detailed environments',
    image: '/styles/european.png',
  },
  {
    id: 'indie',
    name: 'Graphic Novel',
    desc: 'Muted tones, moody, literary aesthetic',
    image: '/styles/indie.png',
  },
  {
    id: 'retro',
    name: 'Retro Pop Art',
    desc: 'Halftone dots, primary colors, bold text',
    image: '/styles/retro.png',
  },
];

export function ComicStylePicker() {
